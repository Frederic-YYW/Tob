 ...
 */
public class IrisSyncApi {

    protected static Logger log = LoggerFactory.getLogger(IrisSyncApi.class);
     ...
     * "bcjr_csrq" : "1988-10-12",
     ...
     "hmcjsbxhdm" : "03",
     */
    public static String Post(String targetHost,String url,Object object) throws NetworkErrorException{
...
//            String targetHost = StringUtils.trim(ConfigHelper.getString("iris.center.host"));
    ...
    public static String regIris(String host,String regUrl, Object params) throws NetworkErrorException {
        return IrisSyncApi.Post( host, regUrl, params);
    }

    public static String inspectionIris(String host,String recoUrl, Object params) throws NetworkErrorException{
        return IrisSyncApi.Post(host,recoUrl, params);
    }

    public static String checkIris(String host,String checkUrl, Object params) throws NetworkErrorException{
        return IrisSyncApi.Post(host,checkUrl, params);
    }

    public static String codeTree(String host,String codeTreeUrl, Object params) throws NetworkErrorException{
        return IrisSyncApi.Post(host,codeTreeUrl, params);
    }
